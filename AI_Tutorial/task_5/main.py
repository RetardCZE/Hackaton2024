...
Of course, you will not implement this by yourself, but you can use open optimized implementations like faiss
package from meta. In this task you will compare naive custom implementation with this open source.
"""
...
# Function to calculate L2 distance (Task 4)
...
# investigate D and I matrices of faiss index (google)
start = time.time()
# D, I = index.search()
end = time.time()
vectorstore_time = end - start
print("Top 5 by faiss index:", "[I - array]", " found in", vectorstore_time, 'time')
